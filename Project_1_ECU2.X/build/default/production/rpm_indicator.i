...
# 11 "rpm_indicator.c" 2
# 1 "./adc.h" 1
# 24 "./adc.h"
void init_adc(void);
unsigned short read_adc(unsigned char channel);
# 12 "rpm_indicator.c" 2
# 1 "./main_ecu2.h" 1
# 13 "./main_ecu2.h"
void get_rpm(void);
void get_indicator(void);
# 13 "rpm_indicator.c" 2
# 1 "./ssd.h" 1
# 22 "./ssd.h"
void SSD_Display(unsigned char Data[]);
# 14 "rpm_indicator.c" 2
# 1 "./can.h" 1
# 45 "./can.h"
void init_can(void);
...
# 15 "rpm_indicator.c" 2
# 1 "./msg_id.h" 1
# 16 "rpm_indicator.c" 2

static unsigned char ssd[4] = {0xE7, 0xE7, 0xE7, 0xE7};
static unsigned char digit[] = {0xE7, 0x21,0xCB, 0x6B, 0x2D, 0x6E, 0xEE, 0x23, 0xEF, 0x6F};

unsigned int rpm;
unsigned int count;
unsigned int key = 0x0F;

unsigned char indicator[4][4] = {"OFF", "LS", "RS", "HL"};

void get_rpm()
{
    rpm = read_adc(0x04) * 5.866;
...
void get_indicator()
{
    ...
    can_transmit(0x50, indicator[index], 4);
}
